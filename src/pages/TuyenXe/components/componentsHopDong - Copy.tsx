const html = (
    `
    <div class="container page-hd-content">
        <div class="header-left">Hợp Đồng Số 1</div>
        <div class="header-center">
            <h2>CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</h2>
            <p><strong>Độc lập – Tự do – Hạnh phúc</strong></p>
            <h3>HỢP ĐỒNG THUÊ XE DỊCH VỤ</h3>
        ...
        <div class="content-hd">
            ...
            <span data-value="1" id="thongtinbenb" data-style="textboxlive">
                <div class="info-split" style="display: flex ;justify-content: space-between;gap: 20px;font-size: 13px;">
                    <div>
                ...
                <table class="info-table" style="width: 100%;border-collapse: collapse;margin-top: 10px;font-size:13px">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="border: 1px solid #000;padding: 2px;text-align: center;">Hành khách 1</td>
                            <td style="border: 1px solid #000;padding: 2px;text-align: center;">0905432258</td>
                            <td style="border: 1px solid #000;padding: 2px;text-align: center;">145 HTK</td>
                            <td style="border: 1px solid #000;padding: 2px;text-align: center;">HV</td>
                        </tr>
                        <tr>
                            <td style="border: 1px solid #000;padding: 2px;text-align: center;">2</td>
                            <td style="border: 1px solid #000;padding: 2px;text-align: center;">Hành khách 2</td>
                            <td style="border: 1px solid #000;padding: 2px;text-align: center;">0981123345</td>
                            <td style="border: 1px solid #000;padding: 2px;text-align: center;">98 HỒNG LỘC</td>
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid #000;padding: 2px;text-align: center;">Hành khách 3</td>
                            <td style="border: 1px solid #000;padding: 2px;text-align: center;">0932312323</td>
                            <td style="border: 1px solid #000;padding: 2px;text-align: center;">1 TRẦN QUỲNH</td>
                            <td style="border: 1px solid #000;padding: 2px;text-align: center;">87 LÊ VĂN HƯU</td>
                        </tr>
                        <tr>
                            <td style="border: 1px solid #000;padding: 2px;text-align: center;">4</td>
                            <td style="border: 1px solid #000;padding: 2px;text-align: center;">Hành khách 4</td>
                            <td style="border: 1px solid #000;padding: 2px;text-align: center;">0911123321</td>
                            <td style="border: 1px solid #000;padding: 2px;text-align: center;">9 TRƯƠNG ĐỊNH</td>
                            <td style="border: 1px solid #000;padding: 2px;text-align: center;">0</td>
                        </tr>
                    </tbody>
                </table>
            ...
            <p>Tổng giá trị hợp đồng: <strong><span class="doithongtin" data-value="0" id="giatrihopdong" data-style="textboxlive">400.000</span> đồng</strong></p>
